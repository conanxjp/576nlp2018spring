...
class UTILS(object):
    ...
    def __init__(self, batch_size = 32, dim_sentence = 80, dim_polarity = 3, isSample = True):
        ...
        if isSample:
            self.trainPath = self.dataPath + 'rest_train_840B_sample.csv'
            self.testPath = self.dataPath + 'rest_test_840B_sample.csv'
            self.trainEncodePath = self.dataPath + 'train_840B_sample.npy'
            self.testEncodePath = self.dataPath + 'test_840B_sample.npy'
        else:
            self.trainPath = self.dataPath + 'rest_train_2014_840B_processed.csv'
            self.testPath = self.dataPath + 'rest_test_2014_840B_processed.csv'
            self.trainEncodePath = self.dataPath + 'train_840B.npy'
            self.testEncodePath = self.dataPath + 'test_840B.npy'

        self.glovePath = self.dataPath + 'glove_840B.npy'
